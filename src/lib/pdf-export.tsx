...
// ═══════════════════════════════════════════════════════════════════════════
// PhytoInsight — TYPESETTING ENGINE v35.0
...
//    "ABOUT PhytoInsight" headings from internal blocks (from v34 patch).
//
...
function cleanBrandingText(raw: string): string {
  ...
  return raw
    ...
    .replace(/Pharmahal/gi, 'PhytoInsight')
  ...
  return (
    <Page size="A4" style={S.coverPage}>
      ...
      <View style={S.coverOverlay}>
        ...
        <Text style={S.coverBrand}>PHYTOINSIGHT</Text>
        ...
        <Text style={S.coverCopyright}>{cleanBrandingText('\u00A9 2026 PhytoInsight \u2014 Evidence-Based Pharmacology Intelligence')}</Text>
      </View>
    </Page>
  );
}
...
function HeaderBar({ identity, subject }: { identity: typeof PHARMA_IDENTITY | typeof INTERACT_IDENTITY; subject: string }) {
  ...
  return (
    <View style={[S.headerBar, { backgroundColor: identity.coverBg }]} fixed>
      ...
      <Text style={S.headerBrand} wrap={false}>PhytoInsight</Text>
  ...
  return (
    <>
      ...
      <View style={S.footerBlock} fixed>
        <Text style={S.footerText} wrap={false}>{cleanBrandingText('\u00A9 2026 PhytoInsight. All Rights Reserved. Generated: ' + genDate + ' UTC')}</Text>
      </View>
    </>
  );
}
  ...
  return (
    <View style={S.sectionBox}>
      <Text style={{ fontFamily: 'LiberationSerif', fontSize: 9.5, color: C.body, lineHeight: 1.37, marginBottom: 8 }}>
        PhytoInsight employs a multi-dimensional evidence scoring framework that weights study quality, relevance, and consistency across the available literature. Scores are calculated based on the following criteria, with each dimension contributing to the final composite score (0&ndash;100).
      </Text>
      {/* Table header */}
  ...
  return (
    <View style={S.box}>
      <Text style={{ fontFamily: 'LiberationSerif', fontSize: 9.5, color: C.mid, lineHeight: 1.37, marginBottom: 8 }}>
        PhytoInsight is an evidence-based scientific platform designed to deliver structured evidence intelligence for scientific and professional review, evaluating drug-herb interactions, exploring pharmacological profiles, and retrieving chemical structures from global scientific databases. Applies international publication standards with interactive reference links and dynamic see-also indexing, free of static page numbers for digital display flexibility.
      </Text>
      {[
      ...
      <View style={{ marginTop: 12, paddingTop: 8, borderTopWidth: 0.3, borderTopColor: C.grid }}>
        ...
        <View style={{ flexDirection: 'row', marginBottom: 6, paddingLeft: 4 }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={{ fontFamily: 'LiberationSerif', fontSize: 9.5, color: C.mid, lineHeight: 1.37 }}>Founder, Scientific Lead &amp; Systems Architect</Text>
        ...
        <View style={{ flexDirection: 'row', marginBottom: 6, paddingLeft: 4 }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={{ fontFamily: 'LiberationSerif', fontSize: 9.5, color: C.mid, lineHeight: 1.37 }}>Scientific Review &amp; Methodology Advisor</Text>
            <Link src="https://orcid.org/0000-0002-9229-8216" style={{ textDecoration: 'none' }}>
              <Text style={{ fontFamily: 'Carlito', fontSize: 9, color: LINK_COLOR, lineHeight: 1.37 }}>{breakLongIdentifier('ORCID: 0000-0002-9229-8216')}</Text>
            </Link>
          </View>
        </View>
        {/* Dr. Shaymaa Mohamed */}
        <View style={{ flexDirection: 'row', marginBottom: 4, paddingLeft: 4 }}>
          <Text style={{ fontFamily: 'LiberationSerif', fontSize: 9.5, color: C.light, width: 12, flexShrink: 0, lineHeight: 1.37 }}>{'\u2022'}</Text>
          <View style={{ flex: 1 }}>
            <Text style={{ fontFamily: 'Carlito', fontWeight: 'bold', fontSize: 9.5, color: C.dark, lineHeight: 1.37 }}>Dr. Shaymaa Mohamed</Text>
            <Text style={{ fontFamily: 'LiberationSerif', fontSize: 9.5, color: C.mid, lineHeight: 1.37 }}>Scientific Evaluation &amp; Conclusions Advisor</Text>
            <Link src="https://orcid.org/0000-0001-7768-0890" style={{ textDecoration: 'none' }}>
              <Text style={{ fontFamily: 'Carlito', fontSize: 9, color: LINK_COLOR, lineHeight: 1.37 }}>{breakLongIdentifier('ORCID: 0000-0001-7768-0890')}</Text>
            </Link>
          </View>
        </View>
      </View>
      ...
      <View style={{ marginTop: 10, paddingVertical: 10, paddingHorizontal: 12, backgroundColor: '#f8f9fa', borderLeftWidth: 4, borderLeftColor: LINK_COLOR, marginBottom: 8 }} wrap={false}>
        ...
        <Text style={{ fontFamily: 'LiberationSerif', fontStyle: 'italic', fontSize: 9.5, color: C.mid, lineHeight: 1.37 }}>
          ...
          <Link src="https://www.phytoinsight.com" style={{ color: LINK_COLOR, textDecoration: 'underline' }}>
            www.phytoinsight.com
          </Link>
        </Text>
      </View>

      <View style={{ borderTopWidth: 0.3, borderTopColor: C.gridHair, marginTop: 8, paddingTop: 5 }}>
        <Text style={{ fontFamily: 'Carlito', fontSize: 8, color: C.faint, lineHeight: 1.4 }}>{cleanBrandingText('\u00A9 2026 PhytoInsight \u2014 Evidence-Based Pharmacology Intelligence Platform')}</Text>
...
export function InteractionPDFDocument({ results, drug, herb, sourcesUsed, fdaData, topCitationCount, aiSummary, aiStructured, scores, confidenceReasoning }: {
  ...
  const tocItems = [
    ...
    ...(hasStructured ? [
      ...
      { num: 17, title: 'About PhytoInsight' },
    ] : [
      ...
      { num: 12, title: 'About PhytoInsight' },
    ]),
  ];
  ...
  return (
    <Document>
      ...
      <Page size="A4" style={S.page} wrap>
        ...
        <SectionBlock>
          <SectionHeading num={hasStructured ? 17 : 12} title="About PhytoInsight" />
          <AboutBlock />
        </SectionBlock>
  ...
  return (
    <Document>
      ...
      <Page size="A4" style={S.page} wrap>
        ...
        <SectionBlock>
          <SectionHeading num={hasStructured ? 15 : 9} title="About PhytoInsight" />
          <AboutBlock />
        </SectionBlock>
