        ...
        <div className="space-y-10">
          ...
          >
            ...
            <p className="text-sm text-gray-500 leading-relaxed font-medium">
              PhytoInsight (&quot;the Platform,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) respects your privacy and is committed to protecting any personal information you may provide while using our scientific evidence platform. This Privacy Policy outlines how we collect, use, and safeguard information when you visit or interact with PhytoInsight.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-500 leading-relaxed font-medium">
                  When you access PhytoInsight, we may automatically collect certain information about your visit, including your IP address, browser type, operating system, referring URLs, and pages viewed. This data is collected for analytics and platform improvement purposes only.
                </p>
              </div>
              <div>
          ...
          >
            ...
            <p className="text-sm text-gray-500 leading-relaxed font-medium mb-3">
              Information collected through PhytoInsight may be used for the following purposes:
            </p>
          ...
          >
            ...
            <p className="text-sm text-gray-500 leading-relaxed font-medium">
              We implement reasonable technical and organizational measures to protect information collected through PhytoInsight. However, no method of electronic transmission or storage is entirely secure, and we cannot guarantee absolute security. We encourage users to take appropriate precautions when sharing information online.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-gray-500 leading-relaxed font-medium">
              We may update this Privacy Policy from time to time. Any changes will be posted on this page with a revised &quot;Last updated&quot; date. Continued use of PhytoInsight following any changes constitutes your acceptance of the updated policy.
            </p>
          </motion.div>
